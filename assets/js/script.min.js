...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Animations)\n/* harmony export */ });\nfunction Animations() {\n  // animation types\n  function fadeTranslateX() {\n    var elements = document.querySelectorAll(\".fade-translate-x\");\n    elements.forEach(function (element) {\n      gsap.fromTo(element, {\n        x: \"100%\",\n        opacity: 0\n      }, {\n        x: \"0%\",\n        opacity: 1,\n        duration: 2,\n        ease: \"expo\",\n        paused: true,\n        scrollTrigger: {\n          trigger: element,\n          start: \"top 80%\",\n          // markers: true,\n          toggleActions: \"play none none none\"\n        }\n      });\n    });\n  }\n  function fadeTranslateY() {\n    var elements = document.querySelectorAll(\".fade-translate-y\");\n    elements.forEach(function (element) {\n      gsap.fromTo(element, {\n        y: \"100%\",\n        opacity: 0\n      }, {\n        y: \"0%\",\n        opacity: 1,\n        duration: 2,\n        ease: \"expo\",\n        paused: true,\n        scrollTrigger: {\n          trigger: element,\n          start: \"top 80%\",\n          // markers: true,\n          toggleActions: \"play none none none\"\n        }\n      });\n    });\n  }\n  function staggerElementsY() {\n    var wraps = document.querySelectorAll(\".stagger-elements-y\");\n    wraps.forEach(function (wrap) {\n      var staggers = wrap.querySelectorAll(\".stagger-elem\");\n      gsap.from(staggers, {\n        y: \"100%\",\n        opacity: 0,\n        stagger: 0.2,\n        duration: 2,\n        ease: \"expo\",\n        scrollTrigger: {\n          trigger: wrap,\n          start: \"top 45%\",\n          // markers: true,\n          toggleActions: \"play none none none\"\n        }\n      });\n    });\n  }\n  function staggerElementsX() {\n    var wraps = document.querySelectorAll(\".stagger-elements-x\");\n    wraps.forEach(function (wrap) {\n      var staggers = wrap.querySelectorAll(\".stagger-elem\");\n      gsap.from(staggers, {\n        x: \"100%\",\n        opacity: 0,\n        stagger: 0.2,\n        duration: 2,\n        ease: \"expo\",\n        scrollTrigger: {\n          trigger: wrap,\n          start: \"top 70%\",\n          // markers: true,\n          toggleActions: \"play none none none\"\n        }\n      });\n    });\n  }\n  function staggerElementsXnegative() {\n    var wraps = document.querySelectorAll(\".stagger-elements-x-negative\");\n    wraps.forEach(function (wrap) {\n      var staggers = wrap.querySelectorAll(\".stagger-elem\");\n      gsap.from(staggers, {\n        x: \"-100%\",\n        opacity: 0,\n        stagger: -0.2,\n        duration: 2,\n        ease: \"expo\",\n        scrollTrigger: {\n          trigger: wrap,\n          start: \"top 70%\",\n          // markers: true,\n          toggleActions: \"play none none none\"\n        }\n      });\n    });\n  }\n  function appear() {\n    var elements = document.querySelectorAll(\".appear\");\n    elements.forEach(function (element) {\n      gsap.from(element, {\n        opacity: 0,\n        duration: 2,\n        ease: \"power2\",\n        scrollTrigger: {\n          trigger: element,\n          start: \"top 25%\",\n          markers: true,\n          toggleActions: \"play none none none\"\n        }\n      });\n    });\n  }\n  function appearStagger() {\n    var wraps = document.querySelectorAll(\".appear-stagger\");\n    wraps.forEach(function (wrap) {\n      var staggers = wrap.querySelectorAll(\".stagger-elem\");\n      gsap.from(staggers, {\n        opacity: 0,\n        stagger: 0.2,\n        duration: 2,\n        ease: \"expo\",\n        scrollTrigger: {\n          trigger: wrap,\n          start: \"top 55%\",\n          markers: true,\n          toggleActions: \"play none none none\"\n        }\n      });\n    });\n  }\n  // call all functions\n  fadeTranslateX();\n  fadeTranslateY();\n  staggerElementsY();\n  staggerElementsX();\n  staggerElementsXnegative();\n  appear();\n  appearStagger();\n}\n\n//# sourceURL=webpack:///./src/js/Animations.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dom_init__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dom-init */ \"./src/js/dom-init.js\");\n\n_dom_init__WEBPACK_IMPORTED_MODULE_0__[\"default\"].Methods.menuControl = function ($this) {\n  var menu = $this[0];\n  var menuTriggerButton = document.querySelector(\".mobile-btn\");\n  var isMenuOpen = false;\n\n  // utility functions\n  function open() {\n    document.body.classList.add(\"menu-open\");\n    menuTriggerButton.classList.add(\"active\");\n  }\n  function close() {\n    document.body.classList.remove(\"menu-open\");\n    menuTriggerButton.classList.remove(\"active\");\n  }\n\n  // add events (click, mouseover, keydown ...)\n  menuTriggerButton.addEventListener(\"click\", function () {\n    if (isMenuOpen) {\n      isMenuOpen = false;\n      close();\n    } else {\n      isMenuOpen = true;\n      open();\n    }\n  });\n};\n\n//# sourceURL=webpack:///./src/js/methods/menuControl.js?");

/***/ }),

/***/ "./src/js/methods/parallaxController.js":
/*!**********************************************!*\
  !*** ./src/js/methods/parallaxController.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dom_init__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dom-init */ \"./src/js/dom-init.js\");\nfunction _typeof(obj) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && \"function\" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }, _typeof(obj); }\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\nfunction _toPropertyKey(arg) { var key = _toPrimitive(arg, \"string\"); return _typeof(key) === \"symbol\" ? key : String(key); }\nfunction _toPrimitive(input, hint) { if (_typeof(input) !== \"object\" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || \"default\"); if (_typeof(res) !== \"object\") return res; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (hint === \"string\" ? String : Number)(input); }\n\nfunction throttle(cb) {\n  var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 250;\n  var shouldWait = false;\n  return function () {\n    if (shouldWait) return;\n    cb.apply(void 0, arguments);\n    shouldWait = true;\n    setTimeout(function () {\n      shouldWait = false;\n    }, delay);\n  };\n}\n_dom_init__WEBPACK_IMPORTED_MODULE_0__[\"default\"].Methods.parallaxController = function ($this) {\n  var el = $this[0];\n  var FPS = 60;\n  var elements = el.querySelectorAll(\".parallax-scene .image-wrap\");\n  var parallax = throttle(function (event) {\n    elements.forEach(function (imageWrap) {\n      var position = imageWrap.getAttribute(\"value\");\n      var x = (window.innerWidth - event.screenX * position) / 90;\n      var y = (window.innerHeight - event.screenY * position) / 90;\n\n      // imageWrap.style.transform = `translateX(${x}px) translateY(${y}px)`;\n\n      gsap.to(imageWrap, {\n        x: x,\n        y: y,\n        duration: 0.5\n      });\n    });\n  }, 1000 / FPS);\n  var Box = /*#__PURE__*/function () {\n    function Box() {\n      var width = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 5;\n      var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 7;\n      _classCallCheck(this, Box);\n      this.width = width;\n      this.height = height;\n      this.depth = 44;\n    }\n\n    // functions\n    _createClass(Box, [{\n      key: \"getArea\",\n      value: function getArea() {\n        return this.width * this.height;\n      }\n    }]);\n    return Box;\n  }();\n  var test = function test() {\n    console.log(\"test\", this);\n  };\n  test();\n  window.addEventListener(\"mousemove\", parallax);\n};\n\n//# sourceURL=webpack:///./src/js/methods/parallaxController.js?");

/***/ }),

/***/ "./src/js/methods/portfolioControl.js":
/*!********************************************!*\
  !*** ./src/js/methods/portfolioControl.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _dom_init__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dom-init */ \"./src/js/dom-init.js\");\n\n_dom_init__WEBPACK_IMPORTED_MODULE_0__[\"default\"].Methods.teamCardsControl = function ($this) {\n  var el = $this[0];\n  var cards = el.querySelectorAll(\".card\");\n  var anim = gsap.fromTo(cards, {\n    x: 100,\n    opacity: 0\n  }, {\n    x: 0,\n    opacity: 1,\n    duration: 1,\n    paused: true,\n    stagger: 0.05,\n    ease: \"power3.inOut\",\n    scrollTrigger: {\n      trigger: el,\n      start: \"top bottom\",\n      end: \"bottom bottom\",\n      // markers: true,\n      scrub: true\n    }\n  });\n};\n\n//# sourceURL=webpack:///./src/js/methods/teamCardsControl.js?");
...
eval("var map = {\n\t\"./ex.js\": \"./src/js/methods/ex.js\",\n\t\"./example.js\": \"./src/js/methods/example.js\",\n\t\"./menuControl.js\": \"./src/js/methods/menuControl.js\",\n\t\"./parallaxController.js\": \"./src/js/methods/parallaxController.js\",\n\t\"./portfolioControl.js\": \"./src/js/methods/portfolioControl.js\",\n\t\"./slider.js\": \"./src/js/methods/slider.js\",\n\t\"./sliderNews.js\": \"./src/js/methods/sliderNews.js\",\n\t\"./teamCardsControl.js\": \"./src/js/methods/teamCardsControl.js\"\n};\n\n\nfunction webpackContext(req) {\n\tvar id = webpackContextResolve(req);\n\treturn __webpack_require__(id);\n}\nfunction webpackContextResolve(req) {\n\tif(!__webpack_require__.o(map, req)) {\n\t\tvar e = new Error(\"Cannot find module '\" + req + \"'\");\n\t\te.code = 'MODULE_NOT_FOUND';\n\t\tthrow e;\n\t}\n\treturn map[req];\n}\nwebpackContext.keys = function webpackContextKeys() {\n\treturn Object.keys(map);\n};\nwebpackContext.resolve = webpackContextResolve;\nmodule.exports = webpackContext;\nwebpackContext.id = \"./src/js/methods sync recursive \\\\.js$\";\n\n//# sourceURL=webpack:///./src/js/methods/_sync_\\.js$?");
